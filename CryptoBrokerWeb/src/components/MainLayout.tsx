import type { Attachment, Chat, ChatFilter, Message, Profile, Settings, User } from "../types";
...
export function MainLayout(props: MainLayoutProps) {
  ...
  const selectedMessage = props.selectedMessageId ? props.messagesById.get(props.selectedMessageId) : undefined;
